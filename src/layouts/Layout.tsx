...
import { Menu, X, Sun, Moon, Home, User, Share2, BookOpen, PenTool, LayoutDashboard, Briefcase, Award, StickyNote, BarChart3, MessageCircle } from 'lucide-react'
...
const navItems = [
  ...
  { name: '访谈', path: '/interviews', icon: MessageCircle },
  { name: '图表', path: '/visualization', icon: BarChart3 },
